...
class BybitV5Client:
    ...
    def open_orders(self, *, category: str, symbol: str, open_only: int = 0) -> Dict[str, Any]:
        ...
        return self._request("GET", "/v5/order/realtime", params={"category": category, "symbol": symbol, "openOnly": open_only})

    def position_list(self, *, category: str, symbol: str) -> Dict[str, Any]:
        return self._request("GET", "/v5/position/list", params={"category": category, "symbol": symbol})
